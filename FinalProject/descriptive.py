...
def plot_descriptive(y, GDP, SS, HE, FR, GE, SS1 ):
    ...
    display_title('Correlations amongst main variables.', pref='Fig', num=1, center = True)

    plt.show()



def plot_descriptive2(y, GDP, SS, HE, FR, GE, SS1 ):
    ...
    display_title("Correlation between happiness and social support in high- and low-GDP countries", pref='Fig', num=2, center = True)
